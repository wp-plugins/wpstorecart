...
<div class="wrap">
    ...
    <div id="doc-content">
        ...
        <p>In order to see the 
            <a href="http://www.shareyourcart.com" target="_blank" title="Shareyourcart&trade;" onclick=" if(_gaq) _gaq.push(['_trackPageview', '/admin/documentation/logo-click']);">ShareYourCart&trade;</a>
...
<?php endif; ?>
		...
		<li><p>To position the  <a href="http://www.shareyourcart.com" target="_blank" title="Shareyourcart&trade;" onclick=" if(_gaq) _gaq.push(['_trackPageview', '/admin/documentation/logo-click']);">ShareYourCart&trade;</a> button, you need to override the following CSS classes</p>
                    <ul>
		...
		<h2>Custom Button</h2>
		<p>If you want to fully style the  <a href="http://www.shareyourcart.com" target="_blank" title="Shareyourcart&trade;" onclick=" if(_gaq) _gaq.push(['_trackPageview', '/admin/documentation/logo-click']);">ShareYourCart&trade;</a> button, use instead the following HTML code</p>
...
<?php if (isset($action_url) && !empty($action_url)): //only show if a known shopping cart is active ?>
		<h3>Remarks</h3>
		<p>If you want to use the <a href="http://www.shareyourcart.com" target="_blank" title="Shareyourcart&trade;" onclick=" if(_gaq) _gaq.push(['_trackPageview', '/admin/documentation/logo-click']);">ShareYourCart&trade;</a> button on a product's page, you need to <strong>append</strong> <code>&p=&lt;product_id&gt;</code> to the <strong>data-syc-callback_url</strong> value, where <code>&lt;product_id&gt;</code> is the product's id</p>
<?php endif; ?>

<?php if($show_footer):?>
		<h2>Contact</h2>
		<p> If you've got 30 seconds, we'd <a href="http://shareyourcart.uservoice.com" target="_blank" title="forum" class="api-link" onclick=" if(_gaq) _gaq.push(['_trackPageview', '/admin/documentation/forum-click']);">love to know what ideal outcome you'd like ShareYourCart to help bring to your business</a>, or if you have a private question, you can <a href="http://www.shareyourcart.com/contact" target="_blank" class="api-link" onclick=" if(_gaq) _gaq.push(['_trackPageview', '/admin/documentation/contact-click']);">contact us directly</a></p>
		<br />
		<?php endif; ?>
	</div>
</div>