...
wpStoreCart 3 BETA 1 is the result of roughly 10 months of work completely rewriting the wpStoreCart plugin from scratch. 
It is still a work in progress.  Do not use on a live site, as many features are incomplete. 
