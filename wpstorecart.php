...
/* Global variables: */
$wpstorecart_version = '3.3.1';
$wpstorecart_version_int = 303001; // Mm_p__ which is 1 digit for Major, 2 for minor, and 3 digits for patch updates, so version 2.0.14 would be 200014
...
$wpscCarthasBeenCalled = false; // Test to see if theres a cart on this page load, if not, add it
