...
if(!function_exists('wpscCountryCodes')) {
    ...
    function wpscCountryCodes($search) {
        $countrycodes = array(
            __("United States", 'wpstorecart'), __("Canada", 'wpstorecart'),__("United Kingdom", 'wpstorecart'),__("Ireland", 'wpstorecart'),__("Australia", 'wpstorecart'),__("New Zealand", 'wpstorecart'),__("Afghanistan", 'wpstorecart'),__("Albania", 'wpstorecart'),__("Algeria", 'wpstorecart'),__("American Samoa", 'wpstorecart'),
            __("Andorra", 'wpstorecart'),__("Angola", 'wpstorecart'),__("Anguilla", 'wpstorecart'),__("Antarctica", 'wpstorecart'),__("Antigua and Barbuda", 'wpstorecart'),__("Argentina", 'wpstorecart'),__("Armenia", 'wpstorecart'),__("Aruba", 'wpstorecart'),__("Austria", 'wpstorecart'),__("Azerbaijan", 'wpstorecart'),
            __("Bahamas", 'wpstorecart'),__("Bahrain", 'wpstorecart'),__("Bangladesh", 'wpstorecart'),__("Barbados", 'wpstorecart'),__("Belarus", 'wpstorecart'),__("Belgium", 'wpstorecart'),__("Belize", 'wpstorecart'),__("Benin", 'wpstorecart'),__("Bermuda", 'wpstorecart'),__("Bhutan", 'wpstorecart'),__("Bolivia", 'wpstorecart'),__("Bosnia and Herzegovina", 'wpstorecart'),
            __("Botswana", 'wpstorecart'),__("Bouvet Island", 'wpstorecart'),__("Brazil", 'wpstorecart'),__("British Indian Ocean Territory", 'wpstorecart'),__("Brunei Darussalam", 'wpstorecart'),__("Bulgaria", 'wpstorecart'),__("Burkina Faso", 'wpstorecart'),__("Burundi", 'wpstorecart'),__("Cambodia", 'wpstorecart'),
            __("Cameroon", 'wpstorecart'),__("Cape Verde", 'wpstorecart'),__("Cayman Islands", 'wpstorecart'),__("Central African Republic", 'wpstorecart'),__("Chad", 'wpstorecart'),__("Chile", 'wpstorecart'),__("China", 'wpstorecart'),__("Christmas Island", 'wpstorecart'),__("Cocos (Keeling) Islands", 'wpstorecart'),
            __("Colombia", 'wpstorecart'),__("Comoros", 'wpstorecart'),__("Congo", 'wpstorecart'),__("Congo, The Democratic Republic of The", 'wpstorecart'), __("Cook Islands", 'wpstorecart'),__("Costa Rica", 'wpstorecart'),__("Cote D\'ivoire", 'wpstorecart'),__("Croatia", 'wpstorecart'),__("Cuba", 'wpstorecart'),__("Cyprus", 'wpstorecart'),
            __("Czech Republic", 'wpstorecart'),__("Denmark", 'wpstorecart'),__("Djibouti", 'wpstorecart'),__("Dominica", 'wpstorecart'),__("Dominican Republic", 'wpstorecart'),__("East Timor", 'wpstorecart'),__("Ecuador", 'wpstorecart'),__("Egypt", 'wpstorecart'),__("El Salvador", 'wpstorecart'),__("Equatorial Guinea", 'wpstorecart'),__("Eritrea", 'wpstorecart'),__("Estonia", 'wpstorecart'),
            __("Ethiopia", 'wpstorecart'),__("Falkland Islands (Malvinas)", 'wpstorecart'),__("Faroe Islands", 'wpstorecart'),__("Fiji", 'wpstorecart'),__("Finland", 'wpstorecart'),__("France", 'wpstorecart'),__("French Guiana", 'wpstorecart'),__("French Polynesia", 'wpstorecart'),__("French Southern Territories", 'wpstorecart'),
            __("Gabon", 'wpstorecart'),__("Gambia", 'wpstorecart'),__("Georgia", 'wpstorecart'),__("Germany", 'wpstorecart'),__("Ghana", 'wpstorecart'),__("Gibraltar", 'wpstorecart'),__("Greece", 'wpstorecart'),__("Greenland", 'wpstorecart'),__("Grenada", 'wpstorecart'),__("Guadeloupe", 'wpstorecart'),__("Guam", 'wpstorecart'),__("Guatemala", 'wpstorecart'),__("Guinea", 'wpstorecart'),__("Guinea-bissau", 'wpstorecart'),
            __("Guyana", 'wpstorecart'),__("Haiti", 'wpstorecart'),__("Heard Island and Mcdonald Islands", 'wpstorecart'),__("Holy See (Vatican City State)", 'wpstorecart'),__("Honduras", 'wpstorecart'),__("Hong Kong", 'wpstorecart'),__("Hungary", 'wpstorecart'),__("Iceland", 'wpstorecart'),__("India", 'wpstorecart'),__("Indonesia", 'wpstorecart'),
            __("Iran, Islamic Republic of", 'wpstorecart'),__("Iraq", 'wpstorecart'),__("Israel", 'wpstorecart'),__("Italy", 'wpstorecart'),__("Jamaica", 'wpstorecart'),__("Japan", 'wpstorecart'),__("Jordan", 'wpstorecart'),__("Kazakhstan", 'wpstorecart'),__("Kenya", 'wpstorecart'),__("Kiribati", 'wpstorecart'),__("Korea, Democratic People\'s Republic of", 'wpstorecart'),
            __("Korea, Republic of", 'wpstorecart'),__("Kosovo", 'wpstorecart'),__("Kuwait", 'wpstorecart'),__("Kyrgyzstan", 'wpstorecart'),__("Lao People\'s Democratic Republic", 'wpstorecart'),__("Latvia", 'wpstorecart'),__("Lebanon", 'wpstorecart'),__("Lesotho", 'wpstorecart'),__("Liberia", 'wpstorecart'),__("Libyan Arab Jamahiriya", 'wpstorecart'),
            __("Liechtenstein", 'wpstorecart'),__("Lithuania", 'wpstorecart'),__("Luxembourg", 'wpstorecart'),__("Macao", 'wpstorecart'),__("Macedonia, The Republic of", 'wpstorecart'),__("Madagascar", 'wpstorecart'),__("Malawi", 'wpstorecart'),__("Malaysia", 'wpstorecart'),__("Maldives", 'wpstorecart'),__("Mali", 'wpstorecart'),
            __("Malta", 'wpstorecart'),__("Marshall Islands", 'wpstorecart'),__("Martinique", 'wpstorecart'),__("Mauritania", 'wpstorecart'),__("Mauritius", 'wpstorecart'),__("Mayotte", 'wpstorecart'),__("Mexico", 'wpstorecart'),__("Micronesia, Federated States of", 'wpstorecart'),__("Moldova, Republic of", 'wpstorecart'),
            __("Monaco", 'wpstorecart'),__("Mongolia", 'wpstorecart'),__("Montenegro", 'wpstorecart'),__("Montserrat", 'wpstorecart'),__("Morocco", 'wpstorecart'),__("Mozambique", 'wpstorecart'),__("Myanmar", 'wpstorecart'),__("Namibia", 'wpstorecart'),__("Nauru", 'wpstorecart'),__("Nepal", 'wpstorecart'),__("Netherlands", 'wpstorecart'),__("Netherlands Antilles", 'wpstorecart'),__("New Caledonia", 'wpstorecart'),
            __("Nicaragua", 'wpstorecart'),__("Niger", 'wpstorecart'),__("Nigeria", 'wpstorecart'),__("Niue", 'wpstorecart'),__("Norfolk Island", 'wpstorecart'),__("Northern Mariana Islands", 'wpstorecart'),__("Norway", 'wpstorecart'),__("Oman", 'wpstorecart'),__("Pakistan", 'wpstorecart'),__("Palau", 'wpstorecart'),
            __("Palestinian Territory, Occupied", 'wpstorecart'),__("Panama", 'wpstorecart'),__("Papua New Guinea", 'wpstorecart'),__("Paraguay", 'wpstorecart'),__("Peru", 'wpstorecart'),__("Philippines", 'wpstorecart'),__("Pitcairn", 'wpstorecart'),__("Poland", 'wpstorecart'),__("Portugal", 'wpstorecart'),__("Puerto Rico", 'wpstorecart'),
            __("Qatar", 'wpstorecart'),__("Reunion", 'wpstorecart'),__("Romania", 'wpstorecart'),__("Russian Federation", 'wpstorecart'),__("Rwanda", 'wpstorecart'),__("Saint Helena", 'wpstorecart'),__("Saint Kitts and Nevis", 'wpstorecart'),__("Saint Lucia", 'wpstorecart'),__("Saint Pierre and Miquelon", 'wpstorecart'),
            __("Saint Vincent and The Grenadines", 'wpstorecart'),__("Samoa", 'wpstorecart'),__("San Marino", 'wpstorecart'),__("Sao Tome and Principe", 'wpstorecart'),__("Saudi Arabia", 'wpstorecart'),__("Senegal", 'wpstorecart'),__("Serbia", 'wpstorecart'),__("Seychelles", 'wpstorecart'),
            __("Sierra Leone", 'wpstorecart'),__("Singapore", 'wpstorecart'),__("Slovakia", 'wpstorecart'),__("Slovenia", 'wpstorecart'),__("Solomon Islands", 'wpstorecart'),__("Somalia", 'wpstorecart'),__("South Africa", 'wpstorecart'),__("South Georgia and The South Sandwich Islands", 'wpstorecart'),__("South Sudan", 'wpstorecart'),__("Spain", 'wpstorecart'),
            __("Sri Lanka", 'wpstorecart'),__("Sudan", 'wpstorecart'),__("Suriname", 'wpstorecart'),__("Svalbard and Jan Mayen", 'wpstorecart'),__("Swaziland", 'wpstorecart'),__("Sweden", 'wpstorecart'),__("Switzerland", 'wpstorecart'),__("Syrian Arab Republic", 'wpstorecart'),__("Taiwan, Province of China", 'wpstorecart'),
            __("Tajikistan", 'wpstorecart'),__("Tanzania, United Republic of", 'wpstorecart'),__("Thailand", 'wpstorecart'),__("Timor-leste", 'wpstorecart'),__("Togo", 'wpstorecart'),__("Tokelau", 'wpstorecart'),__("Tonga", 'wpstorecart'),__("Trinidad and Tobago", 'wpstorecart'),__("Tunisia", 'wpstorecart'),__("Turkey", 'wpstorecart'),
            __("Turkmenistan", 'wpstorecart'),__("Turks and Caicos Islands", 'wpstorecart'),__("Tuvalu", 'wpstorecart'),__("Uganda", 'wpstorecart'),__("Ukraine", 'wpstorecart'),__("United Arab Emirates", 'wpstorecart'),__("United States Minor Outlying Islands", 'wpstorecart'),__("Uruguay", 'wpstorecart'),
            __("Uzbekistan", 'wpstorecart'),__("Vanuatu", 'wpstorecart'),__("Venezuela", 'wpstorecart'),__("Vietnam", 'wpstorecart'),__("Virgin Islands, British", 'wpstorecart'),__("Virgin Islands, U.S.", 'wpstorecart'),__("Wallis and Futuna", 'wpstorecart'),__("Western Sahara", 'wpstorecart'),__("Yemen", 'wpstorecart'),
            __("Zambia", 'wpstorecart'),__("Zimbabwe", 'wpstorecart')
			);
